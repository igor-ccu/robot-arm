...
def detector_blue(src):
    """
    this is for convinience
    same as detector(src, obj) but obj is blue circle
    """
    return detector(src, 'blue_circle')

def detector_green(src):
    """
    this is for convinience
    same as detector(src, obj) but obj is green circle
    """
    return detector(src, 'green_circle')
