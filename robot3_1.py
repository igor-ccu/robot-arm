...
def feature1(image, object):
    pos1 = []
    pro1 = []

    if object == 'blue_circle':
        circle = cv2.inRange(image, (160, 95, 40), (190, 110, 65))
        m = [174, 106, 53]
        sd = [4.7, 2.6, 3.3]
    elif object == 'green_circle':
        circle = cv2.inRange(image, (70, 100, 35), (90, 120, 65))
        m = [80, 108, 49]
        sd = [3, 2.5, 4.6]
    ...
    closing = cv2.morphologyEx(circle, cv2.MORPH_CLOSE, kernel)
...
if __name__ == "__main__":
    ...
    # image = cv2.imread('CircleBinary.jpg', 1)
    # image = cv2.imread('CirclePosition.jpg', 1)
    image = cv2.imread('CircleChalleng2.jpg', 1)
    image = cv2.resize(image, (640, 360))

    pos1, pro1, closing = feature1(image.copy(), object)
    pro2 = feature2(image.copy(), pos1)
    pro3 = feature3(closing)
    ...
    if pos1:
        ...
        print([pro1[pro3Index], pro2[pro3Index], pro3[pro3Index]])
    ...
    print(outputPos, outputPro)

    cv2.circle(image, (outputPos[0], outputPos[1]), 1, (0, 0, 255), 4)
